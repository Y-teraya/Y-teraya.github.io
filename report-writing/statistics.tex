...
\newtcolorbox{moderncolumn}[1][]{
  enhanced,
  breakable,
  colback=white,
  colframe=violet!60!blue,
  boxrule=0pt,
  leftrule=4pt,
  borderline west={4pt}{0pt}{violet!60!blue},
  fonttitle=\bfseries\sffamily,
  title={\faInfoCircle\ Column},
  coltitle=violet!60!blue,
...
特に，指数が正の整数($n > 0$\footnote{\label{note: notation-ref}第Ⅱ部の\textbf{数学の記法}で取り扱う．})のとき\textbf{累乗}といい，それ以外の場合は，\textbf{べき乗}Exponentという．
...
少し捉えにくいかもしれない．$a$を$m$回掛けたものに\textbf{更に$\bm{n}$回掛けたら}，それは$a$を$m \times n$回掛けたものと同じになる．ただ，それだけの話．
...
\begin{moderncolumn}
  ...
  \underline{\textbf{余談}: 平均にもいろんな種類がある！}
